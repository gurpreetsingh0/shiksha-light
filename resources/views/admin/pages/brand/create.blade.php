                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{old('name')}}" placeholder="Enter Brand Name" required>
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-3 col-form-label">Select File:</label>
                                           <img id="blah" class="mb-1"  style="opacity: 4;width: 120px; height:120px; border:1px solid black;margin-left:8px;" src="https://media.istockphoto.com/id/1332100919/vector/man-icon-black-icon-person-symbol.jpg?s=612x612&w=0&k=20&c=AVVJkvxQQCuBhawHrUhDRTCeNQ3Jgt0K1tXjJsFy1eg=" alt="your image" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="status" class="form-control @error('status') is-invalid @enderror" required autofocus>
                                            <option value="1" <?php echo old('status') == "1" ? 'selected="selected"' : ''; ?>>Active</option>
                                            <option value="0" <?php echo old('status') == "0" ? 'selected="selected"' : ''; ?>>Inactive</option>
                                        </select>
                                        <div class="help-block with-errors"></div>
                                            @error('status')
                                                <span class="invalid-feedback" role="alert">
