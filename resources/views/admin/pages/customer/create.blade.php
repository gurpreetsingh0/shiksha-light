                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{old('name')}}" placeholder="Enter Customer Name" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="phone_number" type="tel" class="form-control @error('phone_number') is-invalid @enderror" name="phone_number" placeholder="Enter Phone Number" value="{{old('phone_number')}}" required>
                                        <div class="help-block with-errors"></div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea id="notes" class="form-control" name="notes" placeholder="Enter Note">{{old('notes')}}</textarea>
                                    </div>
