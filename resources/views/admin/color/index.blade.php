        ...
        <div class="row align-items-end">
          <div class="col-lg-8">
            <div class="page-header-title">
              ...
              <div class="d-inline">
                <h5>Color</h5>
                <span>View, delete and update Color</span>
              </div>
            </div>
          </div>
          <div class="col-lg-4">
        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header row">
              ...
              @include('admin.color.search')
              @include('admin.color.edit',['modal_header'=>'Edit Category','heder_font'=>'ik-sliders'])
              </div>
